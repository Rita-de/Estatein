  ...
  return (
      <div className="flex flex-col w-full md:w-auto">
          ...
          <div className="w-full max-w-xs bg-transparent border border-[#262626] rounded-xl p-4 flex flex-col justify-between  mx-auto
            ...
            <span className="w-full h-40 sm:h-49 bg-[url(/home/homebg2.png)] bg-cover bg-center bg-no-repeat rounded-lg"></span>
           ...
           A chic and fully-furnished 2-bedroom apartment with panoramic city views... Read More
            ...
            <div className="flex flex-wrap gap-2">
              <span className="flex items-center gap-1.5 bg-[#2226] px-2 py-1 rounded-lg border border-[#333]">
                <BedDouble width={20} />
                <p className="text-xs">2-Bedroom</p>
              </span>
              <span className="flex items-center gap-1.5 bg-[#2226] px-2 py-1 rounded-lg border border-[#333]">
                <Bath width={20} />
                <p className="text-xs">2-Bathroom</p>
              </span>
              <span className="flex items-center gap-1.5 bg-[#2226] px-2 py-1 rounded-lg border border-[#333]">
                <Building2 width={20} />
